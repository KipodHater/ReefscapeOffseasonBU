...
/**
 * Configuration class for a servo motor subsystem.
 * Includes motor controller settings and position limits.
 * @author Eitan Dror
 * @param name Motor name
 * @param id Motor controller CAN ID
 * @param sparkConfig Spark Max motor controller configuration
 * @param unitToRotorRatio Ratio of rotor to units of this subsystem. Rotor * this should be the units.

...
public class MotorSubsystem<T extends MotorInputsAutoLogged, U extends MotorIO>  extends SubsystemBase {
    ...
    public void periodic() {
        ...
        Logger.recordOutput(getName() + "/latencyPeriodicSeconds", RobotController.getFPGATime() * 1e-6 - timestamp);
    }
    ...
    public void setVelocitySetpoint(double velocityUnitsPerSecond) {
        Logger.recordOutput(getName() + "/Requested/SetpointVelocityUnitsPerSecond", velocityUnitsPerSecond);
    ...
    public void setMaxMotionSetpointVelocity(double velocityUnitsPerSecond) {
        Logger.recordOutput(getName() + "/Requested/MaxMotionSetpointVelocityUnitsPerSecond", velocityUnitsPerSecond);

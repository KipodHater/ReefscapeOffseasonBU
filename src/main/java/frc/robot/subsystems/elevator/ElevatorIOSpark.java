...
public class ElevatorIOSpark implements ElevatorIO {
    ...
    public ElevatorIOSpark() {
        ...
        config.idleMode(ELEVATOR_BRAKE? 
        ...
        elevatorPIDController = new ProfiledPIDController(GAINS.KP(), GAINS.KI(), GAINS.KD(), ELEVATOR_CONSTRAINTS);
    }
    ...
    public void updateInputs(ElevatorIOInputs inputs) {
        ...
        inputs.positionDeg = elevatorEncoder.getPosition();
        inputs.velocityDegPerSec = elevatorEncoder.getVelocity();
    ...
    public void runPosition(double position, double feedforward) {
        runVoltage(feedforward + elevatorPIDController.calculate(elevatorEncoder.getPosition(), position));
    }

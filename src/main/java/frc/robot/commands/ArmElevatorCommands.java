...
public class ArmElevatorCommands {
    ...
    private boolean moveToDefaultFunction(Arm arm, Elevator elevator) {
    ...
    public Command moveToDefault(Arm arm, Elevator elevator) {
        return new FunctionalCommand(
            () -> {}, // initialize: do nothing
            () -> {}, // execute: do nothing
            interrupted -> {}, // end: optional cleanup
            () -> moveToDefaultFunction(arm, elevator), // check if finished
            arm, elevator
